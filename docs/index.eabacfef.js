 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cG{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new cm("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new cK(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,n){if(!e.name)throw new cw("Cached content must contain a `name` field.");if(!e.model)throw new cw("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==t?void 0:t[n])&&e[n]&&(null==t?void 0:t[n])!==e[n]){if("model"===n&&(t.model.startsWith("models/")?t.model.replace("models/",""):t.model)===(e.model.startsWith("models/")?e.model.replace("models/",""):e.model))continue;throw new cw(`Different value for "${n}" specified in modelParams (${t[n]}) and cachedContent (${e[n]})`)}let r=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new cK(this.apiKey,r,n)}}let cW=!1;async function cQ(){try{let e=await function(e){e=aB(e,az);let t=aB(e.firestore,aJ);return(function(e,t,n={}){let r=new nC;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new aS({next:a=>{s.su(),t.enqueueAndForget(()=>oZ(e,o));let l=a.docs.has(n);!l&&a.fromCache?i.reject(new nT(nb.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&a.fromCache&&r&&"server"===r.source?i.reject(new nT(nb.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(a)},error:e=>i.reject(e)}),o=new o3(new r6(n.path),s,{includeMetadataChanges:!0,Ta:!0});return oX(e,o)})(await aD(e),e.asyncQueue,t,n,r)),r.promise})(aX(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new lI(e);return new lw(e,i,t._key,r,new lv(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}(aW(cf,"apikey","googlegenai"));if(e.exists()){let t=e.data().key;console.log("✅ Google Gemini API Key Loaded:",t),n=new cG(t).getGenerativeModel({model:"gemini-1.5-flash"}),cW=!0}else cJ("\uD83D\uDEA8 No Google Gemini API key found in Firestore")}catch(e){console.error("\uD83D\uDEA8 Error fetching API key:",e.message),cJ("\uD83D\uDEA8 Chatbot error: API Key issue.")}}async function cY(e){if(!cW||!n){cJ("\uD83D\uDEA8 AI is still initializing... Please wait.");return}try{cJ(`\u{1F9D1}\u{200D}\u{1F4BB} You: ${e}`);let t=await n.generateContent({contents:[{role:"user",parts:[{text:e}]}]});console.log("\uD83D\uDFE1 AI Full Response:",t);let r=t?.candidates?.[0]?.content?.parts?.[0]?.text||"\uD83D\uDEAB AI did not generate a response.";cJ(`\u{1F916} AI: ${r}`)}catch(e){console.error("\uD83D\uDEA8 Chatbot Error:",e),cJ(`\u{1F6A8} Chatbot Error: ${e.message||"Could not reach AI"}`)}}function cJ(e){let t=document.getElementById("chat-history");if(!t)return;let n=document.createElement("div");n.textContent=e,n.className="history",t.appendChild(n),t.scrollTop=t.scrollHeight}function cX(){let e=document.getElementById("chat-input");if(!e)return;let t=e.value.trim();t?!function(e){let t=e.toLowerCase();if(t.startsWith("add recipe")){let[e,n,r]=t.replace("add recipe","").trim().split(";");return e&&n&&r?(c1(e.trim(),n.trim(),r.split(",")),cJ(`\u{2705} Recipe '${e}' added successfully!`)):cJ("⚠️ Format: 'add recipe Name; Category; ingredient1, ingredient2'"),!0}if(t.startsWith("show recipes"))return c2(),cJ("\uD83D\uDCDC Showing all your recipes..."),!0;if(t.startsWith("find recipe")){let e=t.replace("find recipe","").trim();return c2(e),cJ(`\u{1F50D} Searching for recipes with '${e}'...`),!0}return!1}(t)&&cY(t):cJ("⚠️ Please enter a prompt."),e.value=""}function cZ(){localStorage.removeItem("email"),window.location.href="index.html"}function c0(){let e=document.getElementById("recipeInput").value.trim(),t=document.getElementById("categoryInput").value.trim(),n=document.getElementById("ingredientsInput").value.trim().split(",");e&&t&&n.length>0?c1(e,t,n):alert("\uD83D\uDEA8 Please fill out all fields.")}async function c1(e,t,n){let r=JSON.parse(localStorage.getItem("email"));if(!r){alert("You must be logged in to add recipes.");return}try{await function(e,t){var n,r,i;let s=aB(e.firestore,aJ),o=aW(e),a=(n=e.converter)?n.toFirestore(t):t;return(r=s,i=[(function(e,t,n,r,i,s={}){let o,a;let l=e.ju(s.merge||s.mergeFields?2:0,t,n,i);lr("Data must be an object, but it was:",l,r);let u=lt(r,l);if(s.merge)o=new n8(l.fieldMask),a=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=function(e,t,n){if((t=ej(t))instanceof a0)return t._internalPath;if("string"==typeof t)return ls(e,t);throw lo("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!l.contains(i))throw new nT(nb.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}o=new n8(e),a=l.fieldTransforms.filter(e=>o.covers(e.field))}else o=null,a=l.fieldTransforms;return new a5(new rP(u),o,a)})(a9(e.firestore),"addDoc",o._key,a,null!==e.converter,{}).toMutation(o._key,iO.exists(!1))],function(e,t){let n=new nC;return e.asyncQueue.enqueueAndForget(async()=>aa(await ax(e).then(e=>e.syncEngine),t,n)),n.promise}(aX(r),i)).then(()=>o)}(aG(cf,"recipes"),{name:e,category:t,ingredients:n,email:r,favorite:!1,created_at:new Date}),c2()}catch(e){console.error("\uD83D\uDEA8 Error adding recipe:",e)}}async function c2(e=""){let t=JSON.parse(localStorage.getItem("email"));if(!t)return;let n=function(e,t,...n){let r=[];for(let i of(t instanceof lh&&r.push(t),function(e){let t=e.filter(e=>e instanceof ld).length,n=e.filter(e=>e instanceof lf).length;if(t>1||t>0&&n>0)throw new nT(nb.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r=r.concat(n)),r))e=i._apply(e);return e}(aG(cf,"recipes"),function(e,t,n){let r=lu("where",e);return lf._create(r,"==",n)}("email",0,t)),r=await function(e){e=aB(e,aH);let t=aB(e.firestore,aJ),n=aX(t),r=new lI(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
