 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lk(e,...t){throw lx(e,...t)}function lR(e,...t){return lx(e,...t)}function lN(e,t,n){return new ex("auth","Firebase",Object.assign(Object.assign({},lT()),{[t]:n})).create(t,{appName:e.name})}function lO(e){return lN(e,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function lx(e,...t){if("string"!=typeof e){let n=t[0],r=[...t.slice(1)];return r[0]&&(r[0].appName=e.name),e._errorFactory.create(n,...r)}return lC.create(e,...t)}function lD(e,t,...n){if(!e)throw lx(t,...n)}function lP(e){let t="INTERNAL ASSERTION FAILED: "+e;throw lA(t),Error(t)}function lL(e,t){e||lP(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function l1(e){if(e)try{let t=new Date(Number(e));if(!isNaN(t.getTime()))return t.toUTCString()}catch(e){}}async function l2(e,t=!1){let n=ej(e),r=await n.getIdToken(t),i=l6(r);lD(i&&i.exp&&i.auth_time&&i.iat,n.auth,"internal-error");let s="object"==typeof i.firebase?i.firebase:void 0,o=null==s?void 0:s.sign_in_provider;return{claims:i,token:r,authTime:l1(l3(i.auth_time)),issuedAtTime:l1(l3(i.iat)),expirationTime:l1(l3(i.exp)),signInProvider:o||null,signInSecondFactor:(null==s?void 0:s.sign_in_second_factor)||null}}function l3(e){return 1e3*Number(e)}function l6(e){let[t,n,r]=e.split(".");if(void 0===t||void 0===n||void 0===r)return lA("JWT malformed, contained fewer than 3 sections"),null;try{let e=eE(n);if(!e)return lA("Failed to decode base64 JWT payload"),null;return JSON.parse(e)}catch(e){return lA("Caught error parsing JWT payload as JSON",null==e?void 0:e.toString()),null}}function l5(e){let t=l6(e);return lD(t,"internal-error"),lD(void 0!==t.exp,"internal-error"),lD(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ui{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){lD(e.idToken,"internal-error"),lD(void 0!==e.idToken,"internal-error"),lD(void 0!==e.refreshToken,"internal-error");let t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):l5(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){lD(0!==e.length,"internal-error");let t=l5(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return t||!this.accessToken||this.isExpired?(lD(this.refreshToken,e,"user-token-expired"),this.refreshToken)?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){let{accessToken:n,refreshToken:r,expiresIn:i}=await un(e,t);this.updateTokensAndExpiration(n,r,Number(i))}updateTokensAndExpiration(e,t,n){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+1e3*n}static fromJSON(e,t){let{refreshToken:n,accessToken:r,expirationTime:i}=t,s=new ui;return n&&(lD("string"==typeof n,"internal-error",{appName:e}),s.refreshToken=n),r&&(lD("string"==typeof r,"internal-error",{appName:e}),s.accessToken=r),i&&(lD("number"==typeof i,"internal-error",{appName:e}),s.expirationTime=i),s}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new ui,this.toJSON())}_performRefresh(){return lP("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class u0{constructor(){this.providerId=u0.PROVIDER_ID}static credential(e,t){return uH._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){let n=uZ.parseLink(t);return lD(n,"argument-error"),uH._fromEmailAndCode(e,n.code,n.tenantId)}}u0.PROVIDER_ID="password",u0.EMAIL_PASSWORD_SIGN_IN_METHOD="password",u0.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hS="recaptcha";async function hA(e,t,n){var r;if(!e._getRecaptchaConfig())try{await uM(e)}catch(e){console.log("Failed to initialize reCAPTCHA Enterprise config. Triggering the reCAPTCHA v2 verification.")}try{let i;if(i="string"==typeof t?{phoneNumber:t}:t,"session"in i){let t=i.session;if("phoneNumber"in i){lD("enroll"===t.type,e,"internal-error");let r={idToken:t.credential,phoneEnrollmentInfo:{phoneNumber:i.phoneNumber,clientType:"CLIENT_TYPE_WEB"}},s=async(e,t)=>{if(t.phoneEnrollmentInfo.captchaResponse===ux){lD((null==n?void 0:n.type)===hS,e,"argument-error");let r=await hk(e,t,n);return hi(e,r)}return hi(e,t)},o=uL(e,r,"mfaSmsEnrollment",s,"PHONE_PROVIDER");return(await o.catch(e=>Promise.reject(e))).phoneSessionInfo.sessionInfo}{lD("signin"===t.type,e,"internal-error");let s=(null===(r=i.multiFactorHint)||void 0===r?void 0:r.uid)||i.multiFactorUid;lD(s,e,"missing-multi-factor-info");let o={mfaPendingCredential:t.credential,mfaEnrollmentId:s,phoneSignInInfo:{clientType:"CLIENT_TYPE_WEB"}},a=async(e,t)=>{if(t.phoneSignInInfo.captchaResponse===ux){lD((null==n?void 0:n.type)===hS,e,"argument-error");let r=await hk(e,t,n);return hC(e,r)}return hC(e,t)},l=uL(e,o,"mfaSmsSignIn",a,"PHONE_PROVIDER");return(await l.catch(e=>Promise.reject(e))).phoneResponseInfo.sessionInfo}}{let t={phoneNumber:i.phoneNumber,clientType:"CLIENT_TYPE_WEB"},r=async(e,t)=>{if(t.captchaResponse===ux){lD((null==n?void 0:n.type)===hS,e,"argument-error");let r=await hk(e,t,n);return uG(e,r)}return uG(e,t)},s=uL(e,t,"sendVerificationCode",r,"PHONE_PROVIDER");return(await s.catch(e=>Promise.reject(e))).sessionInfo}}finally{null==n||n._reset()}}async function hk(e,t,n){lD(n.type===hS,e,"argument-error");let r=await n.verify();lD("string"==typeof r,e,"argument-error");let i=Object.assign({},t);if("phoneEnrollmentInfo"in i){let e=i.phoneEnrollmentInfo.phoneNumber,t=i.phoneEnrollmentInfo.captchaResponse,n=i.phoneEnrollmentInfo.clientType,s=i.phoneEnrollmentInfo.recaptchaVersion;return Object.assign(i,{phoneEnrollmentInfo:{phoneNumber:e,recaptchaToken:r,captchaResponse:t,clientType:n,recaptchaVersion:s}}),i}if(!("phoneSignInInfo"in i))return Object.assign(i,{recaptchaToken:r}),i;{let e=i.phoneSignInInfo.captchaResponse,t=i.phoneSignInInfo.clientType,n=i.phoneSignInInfo.recaptchaVersion;return Object.assign(i,{phoneSignInInfo:{recaptchaToken:r,captchaResponse:e,clientType:t,recaptchaVersion:n}}),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hN(e,t){return t?ul(t):(lD(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}hR.PROVIDER_ID="phone",hR.PHONE_SIGN_IN_METHOD="phone";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const h6={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"};class h5{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch(e){}}}const h8=encodeURIComponent("fac");async function h4(e,t,n,r,i,s){lD(e.config.authDomain,e,"auth-domain-config-required"),lD(e.config.apiKey,e,"invalid-api-key");let o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:r,v:tm,eventId:i};if(t instanceof u1)for(let[n,r]of(t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",!function(e){for(let t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}(t.getCustomParameters())&&(o.customParameters=JSON.stringify(t.getCustomParameters())),Object.entries(s||{})))o[n]=r;if(t instanceof u2){let e=t.getScopes().filter(e=>""!==e);e.length>0&&(o.scopes=e.join(","))}for(let t of(e.tenantId&&(o.tid=e.tenantId),Object.keys(o)))void 0===o[t]&&delete o[t];let a=await e._getAppCheckToken(),l=a?`#${h8}=${encodeURIComponent(a)}`:"";return`${function({config:e}){return e.emulator?lV(e,"emulator/auth/handler"):`https://${e.authDomain}/__/auth/handler`}(e)}?${eM(o).slice(1)}${l}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cP(e,t,n,r){return function(e){let[t,n]=(function(e){let t=e.getReader();return new ReadableStream({start(e){let n="";return function r(){return t.read().then(({value:t,done:i})=>{let s;if(i){if(n.trim()){e.error(new cm("Failed to parse stream"));return}e.close();return}let o=(n+=t).match(cx);for(;o;){try{s=JSON.parse(o[1])}catch(t){e.error(new cm(`Error parsing JSON response: "${o[1]}"`));return}e.enqueue(s),o=(n=n.substring(o[0].length)).match(cx)}return r()})}()}})})(e.body.pipeThrough(new TextDecoderStream("utf8",{fatal:!0}))).tee();return{stream:function(e){return function(e,t,n){if(!Symbol.asyncIterator)throw TypeError("Symbol.asyncIterator is not defined.");var r,i=n.apply(e,t||[]),s=[];return r={},o("next"),o("throw"),o("return"),r[Symbol.asyncIterator]=function(){return this},r;function o(e){i[e]&&(r[e]=function(t){return new Promise(function(n,r){s.push([e,t,n,r])>1||a(e,t)})})}function a(e,t){try{var n;(n=i[e](t)).value instanceof cO?Promise.resolve(n.value.v).then(l,u):h(s[0][2],n)}catch(e){h(s[0][3],e)}}function l(e){a("next",e)}function u(e){a("throw",e)}function h(e,t){e(t),s.shift(),s.length&&a(s[0][0],s[0][1])}}(this,arguments,function*(){let t=e.getReader();for(;;){let{value:e,done:n}=yield cO(t.read());if(n)break;yield yield cO(cS(e))}})}(t),response:cD(n)}}(await cb(t,J.STREAM_GENERATE_CONTENT,e,!0,JSON.stringify(n),r))}async function cL(e,t,n,r){let i=await cb(t,J.GENERATE_CONTENT,e,!1,JSON.stringify(n),r);return{response:cS(await i.json())}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cG{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new cm("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new cK(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,n){if(!e.name)throw new cw("Cached content must contain a `name` field.");if(!e.model)throw new cw("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==t?void 0:t[n])&&e[n]&&(null==t?void 0:t[n])!==e[n]){if("model"===n&&(t.model.startsWith("models/")?t.model.replace("models/",""):t.model)===(e.model.startsWith("models/")?e.model.replace("models/",""):e.model))continue;throw new cw(`Different value for "${n}" specified in modelParams (${t[n]}) and cachedContent (${e[n]})`)}let r=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new cK(this.apiKey,r,n)}}async function cW(){try{let e=await function(e){e=aB(e,az);let t=aB(e.firestore,aJ);return(function(e,t,n={}){let r=new nC;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new aS({next:a=>{s.su(),t.enqueueAndForget(()=>oZ(e,o));let l=a.docs.has(n);!l&&a.fromCache?i.reject(new nT(nb.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&a.fromCache&&r&&"server"===r.source?i.reject(new nT(nb.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(a)},error:e=>i.reject(e)}),o=new o3(new r6(n.path),s,{includeMetadataChanges:!0,Ta:!0});return oX(e,o)})(await aD(e),e.asyncQueue,t,n,r)),r.promise})(aX(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new lI(e);return new lw(e,i,t._key,r,new lv(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}(aW(cf,"apikey","googlegenai"));if(e.exists()){let t=e.data().key;console.log("✅ Google Gemini API Key Loaded"),n=new cG(t).getGenerativeModel({model:"gemini-1.5-flash"})}else cY("\uD83D\uDEA8 No Google Gemini API key found in Firestore")}catch(e){console.error("\uD83D\uDEA8 Error fetching API key:",e.message),cY("\uD83D\uDEA8 Chatbot error: API Key issue.")}}async function cQ(e){if(!n){cY("\uD83D\uDEA8 AI is still initializing... Please wait.");return}try{cY(`\u{1F9D1}\u{200D}\u{1F4BB} You: ${e}`);let t=await n.generateContent({contents:[{role:"user",parts:[{text:e}]}]});console.log("\uD83D\uDFE1 AI Full Response:",t);let r=t?.candidates?.[0]?.content?.parts?.[0]?.text||"\uD83D\uDEAB AI did not generate a response.";cY(`\u{1F916} AI: ${r}`)}catch(e){console.error("\uD83D\uDEA8 Chatbot Error:",e),cY(`\u{1F6A8} Chatbot Error: ${e.message||"Could not reach AI"}`)}}function cY(e){let t=document.getElementById("chat-history");if(!t)return;let n=document.createElement("div");n.textContent=e,n.className="history",t.appendChild(n),t.scrollTop=t.scrollHeight}function cJ(){let e=document.getElementById("chat-input");if(!e)return;let t=e.value.trim();t?!function(e){let t=e.toLowerCase();if(t.startsWith("add recipe")){let[e,n,r]=t.replace("add recipe","").trim().split(";");return e&&n&&r?(c0(e.trim(),n.trim(),r.split(",")),cY(`\u{2705} Recipe '${e}' added successfully!`)):cY("⚠️ Format: 'add recipe Name; Category; ingredient1, ingredient2'"),!0}if(t.startsWith("show recipes"))return c1(),cY("\uD83D\uDCDC Showing all your recipes..."),!0;if(t.startsWith("find recipe")){let e=t.replace("find recipe","").trim();return c1(e),cY(`\u{1F50D} Searching for recipes with '${e}'...`),!0}return!1}(t)&&cQ(t):cY("⚠️ Please enter a prompt."),e.value=""}function cX(){localStorage.removeItem("email"),window.location.href="index.html"}function cZ(){let e=document.getElementById("recipeInput").value.trim(),t=document.getElementById("categoryInput").value.trim(),n=document.getElementById("ingredientsInput").value.trim().split(",");e&&t&&n.length>0?c0(e,t,n):alert("\uD83D\uDEA8 Please fill out all fields.")}async function c0(e,t,n){let r=JSON.parse(localStorage.getItem("email"));if(!r){alert("You must be logged in to add recipes.");return}try{await function(e,t){var n,r,i;let s=aB(e.firestore,aJ),o=aW(e),a=(n=e.converter)?n.toFirestore(t):t;return(r=s,i=[(function(e,t,n,r,i,s={}){let o,a;let l=e.ju(s.merge||s.mergeFields?2:0,t,n,i);lr("Data must be an object, but it was:",l,r);let u=lt(r,l);if(s.merge)o=new n8(l.fieldMask),a=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=function(e,t,n){if((t=ej(t))instanceof a0)return t._internalPath;if("string"==typeof t)return ls(e,t);throw lo("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!l.contains(i))throw new nT(nb.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}o=new n8(e),a=l.fieldTransforms.filter(e=>o.covers(e.field))}else o=null,a=l.fieldTransforms;return new a5(new rP(u),o,a)})(a9(e.firestore),"addDoc",o._key,a,null!==e.converter,{}).toMutation(o._key,iO.exists(!1))],function(e,t){let n=new nC;return e.asyncQueue.enqueueAndForget(async()=>aa(await ax(e).then(e=>e.syncEngine),t,n)),n.promise}(aX(r),i)).then(()=>o)}(aG(cf,"recipes"),{name:e,category:t,ingredients:n,email:r,favorite:!1,created_at:new Date}),c1()}catch(e){console.error("\uD83D\uDEA8 Error adding recipe:",e)}}async function c1(e=""){let t=JSON.parse(localStorage.getItem("email"));if(!t)return;let n=function(e,t,...n){let r=[];for(let i of(t instanceof lh&&r.push(t),function(e){let t=e.filter(e=>e instanceof ld).length,n=e.filter(e=>e instanceof lf).length;if(t>1||t>0&&n>0)throw new nT(nb.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r=r.concat(n)),r))e=i._apply(e);return e}(aG(cf,"recipes"),function(e,t,n){let r=lu("where",e);return lf._create(r,"==",n)}("email",0,t)),r=await function(e){e=aB(e,aH);let t=aB(e.firestore,aJ),n=aX(t),r=new lI(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new nT(nb.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new nC;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new aS({next:n=>{s.su(),t.enqueueAndForget(()=>oZ(e,o)),n.fromCache&&"server"===r.source?i.reject(new nT(nb.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),o=new o3(n,s,{includeMetadataChanges:!0,Ta:!0});return oX(e,o)})(await aD(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new l_(t,r,e,n)))}(n),i=document.getElementById("recipeList");i.innerHTML="",r.forEach(t=>{let n=t.data();if(!e||n.name.includes(e)||n.category.includes(e)){let e=document.createElement("li");e.innerHTML=`
        <strong>${n.name}</strong> (${n.category})<br>
        Ingredients: ${n.ingredients.join(", ")}<br>
        <button onclick="toggleFavorite('${t.id}')">\u{2B50}</button>
        <button onclick="editRecipe('${t.id}')">\u{270F}\u{FE0F}</button>
        <button onclick="deleteRecipe('${t.id}')">\u{274C}</button>
      `,i.appendChild(e)}})}function c2(){c1(document.getElementById("filterInput").value.toLowerCase())}document.addEventListener("DOMContentLoaded",()=>{(function(){let e=document.getElementById("send-btn");e&&e.addEventListener("click",cJ);let t=document.getElementById("addRecipeBtn");t&&t.addEventListener("click",cZ);let n=document.getElementById("filterBtn");n&&n.addEventListener("click",c2);let r=document.getElementById("signOutBttn");r&&r.addEventListener("click",cX)})(),cW(),c1()});const c3="recipe-organizer-cache-v4",c6=["./html/index.html","./html/tasks.html","./css/style.css","./app.js","./manifest.json"];self.addEventListener("install",e=>{e.waitUntil(caches.open(c3).then(e=>(console.log("[Service Worker] Pre-caching offline content"),e.addAll(c6)))),self.skipWaiting()}),self.addEventListener("activate",e=>{e.waitUntil(caches.keys().then(e=>Promise.all(e.map(e=>{if(e!==c3)return console.log("[Service Worker] Removing old cache:",e),caches.delete(e)})))),self.clients.claim()}),self.addEventListener("fetch",e=>{e.respondWith(caches.match(e.request).then(t=>t||fetch(e.request).catch(()=>caches.match("./html/index.html"))))});const c5=JSON.parse(localStorage.getItem("email"));window.location.pathname.includes("index.html")&&c5&&(window.location.href="tasks.html"),window.location.pathname.includes("tasks.html")&&!c5&&(window.location.href="index.html");var c8={};c8=new URL("up_/js/service-worker.js",import.meta.url).toString(),"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register(c8).then(e=>console.log("✅ Service Worker Registered:",e)).catch(e=>console.error("\uD83D\uDEA8 Service Worker Registration Failed:",e))});
//# sourceMappingURL=index.187d86c2.js.map
